...
class FMADataset:
    ...
    def __init__(self, data_path='./data', genres=None, n_mfcc=20, 
    ...
    def process_dataset(self, save_path='./data/processed_features.pkl'):
        """
    ...
    @staticmethod
    def load_processed(path='./data/processed_features.pkl'):
